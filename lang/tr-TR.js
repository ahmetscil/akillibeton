export default {
  ...
  err: {
    ...
    concrete_pouring_error: 'Beton Döküm Tarihi girilmemiş ölçümler başlatılamaz.'
  },
  router: {
    undefined: 'Tanımsız',
    Auth: 'Yetkilendirme',
  ...
  general: {
    ...
    address: 'Adres',
    companyName: 'Firma',
    uploadInfo: 'Dosya Yükle',
    uploading: 'Yükleniyor',
    reUpload: 'Yeniden Yükle',
    uploadOK: 'Yükleme Tamamlandı',
  ...
  auth: {
    ...
    code: 'Sıfırlama Kodu',
    resetted: 'Şifreniz Sıfırlandı',
    changePassword: 'Şifremi Değiştir',
    waitTheCode: 'Lütfen e-posta adresinize gelen onay kodunu girin',
  ...
  action: {
    ...
    name: 'İsim',
    concrete_pouring_time: 'Beton Dök. Tarihi',
    concrete_pouring_temp: 'Beton Dök. Sıcaklığı',
    reference_temp: 'Referans Sıcaklık',
    sensorsTitle: 'Cihaz',
    mixTitle: 'Mix İsmi',
    mix: 'Mix',
    description: 'Açıklama',
